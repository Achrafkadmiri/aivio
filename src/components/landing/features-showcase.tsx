...
// No per-group media sample here — the page's video/image content is kept
// to the dedicated "See it in action" showcase section instead of being
// repeated in every section, so each group is just its item list.
const GROUPS = [
  {
    label: "Create",
    items: [
