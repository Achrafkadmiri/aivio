      ...
      <Reveal>
        ...
        >
          {/* Halftone dot texture, brand-pink radial glow, and a large
              abstract "S" ribbon watermark — all decorative, no text. */}
          <div
            className="pointer-events-none absolute inset-0 opacity-40"
            style={{
              backgroundImage: "radial-gradient(rgb(244 63 94 / 0.5) 1px, transparent 1px)",
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse 60% 80% at 5% 40%, rgb(244 63 94 / 0.18), transparent 70%)",
            }}
            aria-hidden="true"
          />
          <svg
          ...
          <div className="relative">
            <div className="flex flex-wrap items-center gap-2">
              <span className="rounded-md bg-blue-500 px-2.5 py-1 text-caption font-black tracking-wide text-white uppercase">
                Exclusive access
              </span>
              <span className="rounded-md bg-lime-400 px-2.5 py-1 text-caption font-black tracking-wide text-black uppercase">
                Seedance 2.5 at 720p
              </span>
            </div>

            <h2 className="mt-4 text-heading leading-[1.05] font-black tracking-tight uppercase sm:text-display">
              <span className="block text-[#F43F5E]">Exclusive Seedance 2.5</span>
